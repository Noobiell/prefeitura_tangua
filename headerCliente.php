    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link branco" aria-current="page" href="#">Início</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link branco" href="#">Preencher Formulário</a>
                </li>
                <li class="nav-item">
            ...
            <div class="containerUsuarioHeader">
                ...
                <span class="cpfHeader"><?php echo $_SESSION['email'] ?></span>
            </div>
        </div>
        <!--Fim collapse-->
    </div>
