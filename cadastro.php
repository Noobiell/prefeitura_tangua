    ...
    <div class="containerCentral">
        ...
        <div class="containerFormLogin">
            ...
            <form id="cadastroCliente">
                ...
                <div class="mb-5">
                    <h1 class="tituloLogin azul">Cadastre-se <strong class="rosa">Pré-Matrícula</strong></h1>
                </div>

                <div class="itemForm mb-4">
                    <label for="nome" class="iconeForm"><i class="fa-solid fa-user"></i></label>
                    <input type="text" class="inputForm" name="nome" id="nome" placeholder="Nome Completo">
                </div>
